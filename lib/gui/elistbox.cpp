...
eListbox::eListbox(eWidget *parent) :
	...
	m_items_per_page(0), m_selection_enabled(1), m_native_keys_bound(false), m_flex_mode(flexVertical), m_itemheight(25), m_columns(2), m_rows(2), m_selectionheight(20), m_selectionwidth(20) xoffset(0), yoffset(0), m_scrollbar(nullptr)
{
