...
eListbox::eListbox(eWidget *parent) :
	...
	m_items_per_page(0), m_selection_enabled(1), xoffset(0), yoffset(0), m_native_keys_bound(false), m_scrollbar(nullptr), m_first_selectable_item(-1), m_last_selectable_item(-1), m_center_list(true)
{
...
void eListbox::moveSelection(long dir)
{
	...
	if(m_content->size() > m_items_per_page && m_flex_mode != flexGrid)
	{
